...
💡 How to fix it yourself in the future:
...
MAVEN_ARGS="-Dsakai.skin.source=unilesa -Dsakai.skin.target=unilesa -Dsakai.skin.customization.file=src/skins/unilesa/src/sass/_tenant.scss" ./scripts/dev.sh build-module library && \
MAVEN_ARGS="-Dsakai.skin.source=main -Dsakai.skin.target=main -Dsakai.skin.customization.file=src/skins/main/src/sass/_tenant.scss" ./scripts/dev.sh build-module library && \
./scripts/dev.sh stop && \
